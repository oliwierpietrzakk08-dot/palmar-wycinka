        ...
        ${p.name === 'realizacje.html' ? `
            <div class="max-w-5xl">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                    <img src="img/img1.jpg" alt="Realizacja 1" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                    <img src="img/img2.jpg" alt="Realizacja 2" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                    <img src="img/img3.jpg" alt="Realizacja 3" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                    <img src="img/img4.jpg" alt="Realizacja 4" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                    <img src="img/img5.jpg" alt="Realizacja 5" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                    <img src="img/img6.jpg" alt="Realizacja 6" class="w-full h-64 object-cover rounded-xl shadow-sm grayscale hover:grayscale-0 transition duration-500">
                </div>
            </div>
        ` : ''}
